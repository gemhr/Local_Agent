...
def test_fault_point_catalog_is_fixed_and_complete_for_foundation() -> None:
    expected = {
        ...
        "PLANNING_BEFORE_RESOLVE",
        "PLANNING_BEFORE_PLAN_CREATED",
        "STEP_BEFORE_DRIVER_EXECUTE",
        "STORE_BEFORE_WRITE_PREPARED",
        "STORE_BEFORE_MARK_READABLE",
        "STORE_BEFORE_DEPENDENCY_READ",
        "OUTPUT_BEFORE_PUBLISH",
        "MEMORY_BEFORE_EXCHANGE_BEGIN",
        "MEMORY_BEFORE_USER_INSERT",
        "MEMORY_BEFORE_ASSISTANT_INSERT",
        "MEMORY_BEFORE_EXCHANGE_COMMIT",
