...
class FaultPoint(str, Enum):
    ...
    # Stage 2.5 WP6 planning chain seams.
    PLANNING_BEFORE_RESOLVE = "PLANNING_BEFORE_RESOLVE"
    PLANNING_BEFORE_PLAN_CREATED = "PLANNING_BEFORE_PLAN_CREATED"

    # Stage 2.5 WP6 specialist/store seams.
    STEP_BEFORE_DRIVER_EXECUTE = "STEP_BEFORE_DRIVER_EXECUTE"
    STORE_BEFORE_WRITE_PREPARED = "STORE_BEFORE_WRITE_PREPARED"
    STORE_BEFORE_MARK_READABLE = "STORE_BEFORE_MARK_READABLE"
    STORE_BEFORE_DEPENDENCY_READ = "STORE_BEFORE_DEPENDENCY_READ"

    # Stage 2.5 WP6 final delivery seam.
    OUTPUT_BEFORE_PUBLISH = "OUTPUT_BEFORE_PUBLISH"

    # Stage 2.5 WP6 final Memory exchange seams.
    MEMORY_BEFORE_EXCHANGE_BEGIN = "MEMORY_BEFORE_EXCHANGE_BEGIN"
    MEMORY_BEFORE_USER_INSERT = "MEMORY_BEFORE_USER_INSERT"
    MEMORY_BEFORE_ASSISTANT_INSERT = "MEMORY_BEFORE_ASSISTANT_INSERT"
    MEMORY_BEFORE_EXCHANGE_COMMIT = "MEMORY_BEFORE_EXCHANGE_COMMIT"
