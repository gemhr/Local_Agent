...
RUNTIME_METRIC_DESCRIPTORS = tuple(
    [
        ...
        _descriptor("runtime_reconciliation_candidates_discovered_total", MetricType.COUNTER, "对账候选发现数", "candidates"),
        _descriptor("runtime_reconciliation_claimed_total", MetricType.COUNTER, "对账 claim 数", "claims"),
        _descriptor("runtime_reconciliation_claim_lost_total", MetricType.COUNTER, "对账 claim 丢失数", "claims"),
        _descriptor("runtime_reconciliation_converged_committed_total", MetricType.COUNTER, "对账收敛为 COMMITTED 数", "invocations"),
        _descriptor("runtime_reconciliation_converged_not_committed_total", MetricType.COUNTER, "对账收敛为 NOT_COMMITTED 数", "invocations"),
        _descriptor("runtime_reconciliation_still_unknown_total", MetricType.COUNTER, "对账仍 UNKNOWN 数", "invocations"),
        _descriptor("runtime_reconciliation_provider_unsupported_total", MetricType.COUNTER, "Provider 不支持对账数", "invocations"),
        _descriptor("runtime_reconciliation_manual_required_total", MetricType.COUNTER, "对账转人工数", "invocations"),
        _descriptor("runtime_reconciliation_manual_resolved_total", MetricType.COUNTER, "人工对账收敛数", "invocations"),
        _descriptor("runtime_reconciliation_failed_total", MetricType.COUNTER, "对账失败数", "invocations"),
        MetricDescriptor(name="runtime_reconciliation_latency_seconds", type=MetricType.HISTOGRAM, description="对账延迟", unit="seconds"),
        _descriptor("runtime_tool_discovery_candidate_count_total", MetricType.COUNTER, "Tool Discovery 候选数量", "candidates"),
        MetricDescriptor(
            name="runtime_tool_discovery_latency_seconds",
            type=MetricType.HISTOGRAM,
            description="Tool Discovery 延迟",
            unit="seconds",
        ),
        _descriptor("runtime_tool_snapshot_created_total", MetricType.COUNTER, "创建的 Tool Resolution Snapshot 数", "snapshots"),
        _descriptor("runtime_continuation_created_total", MetricType.COUNTER, "创建的 durable continuation 数", "continuations"),
        _descriptor("runtime_continuation_claimed_total", MetricType.COUNTER, "claim 的 durable continuation 数", "continuations"),
        _descriptor("runtime_continuation_reaped_total", MetricType.COUNTER, "reaper 回收的 continuation 数", "continuations"),
        _descriptor("runtime_continuation_resume_success_total", MetricType.COUNTER, "恢复成功的 continuation 数", "continuations"),
        _descriptor("runtime_continuation_resume_failure_total", MetricType.COUNTER, "恢复失败的 continuation 数", "continuations"),
        _descriptor("runtime_continuation_lease_lost_total", MetricType.COUNTER, "claim token 已失效的 continuation mutation 数", "continuations"),
