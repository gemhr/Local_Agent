...
| tool invocation-specific spec | ToolAdapter.spec_for(invocation) / ToolExecutionSpec | ToolExecutionService、Recovery | Adapter spec_for 派生 | 不持久化 | INVOCATION_SCOPE | ToolDescriptor、ToolRegistry |
